...
if($_SERVER["REQUEST_METHOD"] == "POST"){
    ...
    if(($password == $cpassword)){
        ...
        $sql = "INSERT INTO `users` (`Fname`, `Lname`, `age`,`mno`, `address`, `email`,`state`, `country`, `username`, `password`, `dt`) VALUES ('$Fname', '$Lname','$age','$mno', '$address','$email','$state', '$country','$username', '$hash', current_timestamp())";
        ...
        if ($result){
            ...
            $_SESSION['country'] = $country; // Store the user's name in the session
            echo '<script>
            setTimeout(function(){
...
<html lang="en">
  ...
  <body>
    ...
    <div class="container my-4">
     <h1 class="text-center">Signup to myDeed</h1>
    ...
    <input type="number" class="form-control" id="mno" name="mno" aria-describedby="emailHelp">
</div>
<div class="form-group">
